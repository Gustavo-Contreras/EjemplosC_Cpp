...
int main ()
{
	...
	cin.sync();// descarta el buffer del retorno del carro
	cout<<" unida : ";
	...
	cout<<"cliente : ";
	cin.getline(cliente7->nombre,20);//getline lee retorno de carro no leido en cin
	cin.sync();
	cout<<" unida : ";
	cin>>cliente7->numUnidades;
	cin.sync();
	cout<<" Precio : ";
	cin>>cliente7->precio;
	cin.sync();
	...
	cin>>cliente7->estado;
	cin.sync();
	cout<<" los datos del cliente son : "<<cliente7->nombre<<", "<<cliente7->numUnidades<<", "<<cliente7->precio<<", "<<cliente7->estado<<endl;
	delete cliente7;
	system("pause");
